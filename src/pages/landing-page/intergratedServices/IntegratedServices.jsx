...
<Col className="col-md">
   ...
   <h5 className={Styles.smalltext}>&ldquo; The Peace of Mind that this Security Company has given me Is So Comforting, knowing that When I am not around I can still Check My family Safety &rdquo;</h5>
   
  <h6 className={Styles.quotetitle}>
